            ...
            <div class="col-lg-9 offset-lg-2 text-center">
                <div class="hero-text">
                    <div class="hero-text-tablecell">
                        ...
                        <h1>Youcode Shop Application</h1>
                        <div class="hero-btns">
                            <a href="/products" class="boxed-btn">Show all product</a>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <p>Copyrights &copy; 2022 - <a href="/">Tayeb SOUINI </a>,  All Rights Reserved.<br>
                    Distributed By - <a href="https://www.youcode.ma">YOUCODE Youssoufia</a>
                </p>
            </div>
